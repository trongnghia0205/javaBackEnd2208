            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="/2208/${product.mainImage}" alt="Image">
                    </div>
                    <c:forEach items="${product.productimageEntityList}" var="p">
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/2208/${p.imageUrl}" alt="Image">
                        </div>
                    </c:forEach>
                </div>
            ...
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" class="form-control bg-secondary border-0 text-center" id="number" value="1">
                        <div class="input-group-btn">
                    ...
                    <sec:authorize access="isAuthenticated()">
                        <button class="btn btn-primary px-3" onclick="order()"><i class="fa fa-shopping-cart mr-1"></i> Thêm vào giỏ hàng</button>
                        <script>
                            function order() {
                                ...
                                var url = "/backend/product/order/${product.id}?color=" + color + "&size=" + size + "&number=" + number;
                    ...
                    <sec:authorize access="hasAnyRole('ADMIN')">
                        <button class="btn btn-primary px-3"  style="margin-left: 10px"><a href="/backend/product/edit/${product.id}" style = "color: black">Sửa</a> </button>
                    </sec:authorize>
                </div>
